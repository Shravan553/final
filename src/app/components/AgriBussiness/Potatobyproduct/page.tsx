...
import Link from 'next/link'; // Correct for Next.js usage

import styles from './Potatobyproduct.module.css';
import Nav from '../../../Navbar/NavbarTYP';
import Footer from '../../../Footer/Footer'; // Ensure correct import casing
...
const products: Product[] = [
  {
    img: '/assets/inflour.png', // Replace with actual image paths
    title: 'Potato Flour',
  ...
  {
    img: '/assets/inmilk.png', // Replace with actual image paths
    title: 'Potato Milk',
  ...
  {
    img: '/assets/infries.png', // Replace with actual image paths
    title: 'Potato Fries',
  ...
  {
    img: '/assets/ingran.png', // Replace with actual image paths
          ...
          {products.map((product, index) => (
            <div key={index} className={styles.byprocard}>
              <div className={styles.byprocontent}>
                <img src={product.img} alt={product.title} className={styles.byproimage} />
