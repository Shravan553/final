...
import HomeAbout1 from "../components/About/page";
...
type NavbarState = {
  click: boolean;
  dropdownAgriBusiness: boolean;
  dropdownPotatoInsights: boolean;
  isMobile: boolean;
};
...
const Navbar: React.FC = () => {
  ...
  const closeMobileMenu = () => {
    if (isMobile) {
      setClick(false); // Ensure the menu closes after clicking a link
    }
  };
  ...
  //   if (isMobile) {
  //     setDropdownAgriBusiness(!dropdownAgriBusiness);
  //     setDropdownPotatoInsights(false);b
